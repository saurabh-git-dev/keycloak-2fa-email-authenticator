...
public class EmailAuthenticatorForm extends AbstractUsernameFormAuthenticator {
    ...
    protected Response challenge(AuthenticationFlowContext context, String error, String field) {
        ...
        Response response = form.createForm("email-verification-with-code-form.ftl");
    ...
    private void generateAndSendEmailCode(AuthenticationFlowContext context) {
        ...
        sendEmailWithCode(context.getSession(), context.getRealm(), context.getUser(), code, ttlMinutes);
    ...
    private void sendEmailWithCode(KeycloakSession session, RealmModel realm, UserModel user, String code, int ttl) {
        ...
        try {
            ...
            emailProvider.send("emailVerificationWithCodeSubject", subjectParams, "email-verification-with-code.ftl", mailBodyAttributes);
